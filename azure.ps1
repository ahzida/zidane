...
$i = Get-AzResource -Name newsite -ResourceGroupName zidane-sentia
Set-AzResource -ResourceId $i.Id -tag @{Sentia=“pre-prod-appplan"} -force

$ii = Get-AzResource -Name $sitename -ResourceGroupName zidane-sentia
...
$string= 'DefaultEndpointsProtocol=https;AccountName=' + $storageaccountname + ';AccountKey=' + $saKey + ';EndpointSuffix=core.windows.net' 
...
#connect website to keyvault secret
